    ...
    <div class="col-lg-12 bg-light">
        ...
        <div class="d-flex flex-wrap justify-content-xl-between">
            <div class="titulo d-flex align-items-center p-4" style="padding-top:20px">
                <span class="font-weight-bold p-2" style="font-family: 'Lato', sans-serif;font-size:28px;">Frenos</span>
            </div> 
        ...
        <div class="tabla">
            ...
            <div class="d-flex row p-0 justify-content-center">
              ...
              <!-- LISTADO POR DEFECTO -->
              <?php $productos = listarCategorias(4);
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php 
                              ...
                              $total_paginas = totalPaginasCategoria(4);

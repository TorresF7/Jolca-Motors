                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <a href="lista-pedido.php" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </a>
                        </div>

                        <div class="modal-body">
                            <p>Error ... ! No ha ingresado el DNI de pedido en la barra de búsqueda</p>
                        </div>

                        <div class="modal-footer">
                            <a href="lista-pedido.php" class="btn btn-danger">Aceptar</a>
                        </div>

<?php
	...
	function DNIExiste($DNI)
	{
		...
		$stmt = $mysqli->prepare("SELECT DNI FROM cliente WHERE DNI = ? LIMIT 1");
	...
	function emailExiste($email)
	{
		...
		$stmt = $mysqli->prepare("SELECT Dni FROM cliente WHERE correo = ? LIMIT 1");
	...
	function registraCliente($Dni, $nombre, $apellidos, $email, $direccion, $telefono){
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->SMTPOptions = array(
		 ...
		 $mail->Host = 'mail.jolcamotors.com'; //Modificar
		 $mail->Port = '587'; //Modificar
		 
		 $mail->Username = 'ventas@jolcamotors.com'; //Modificar
		 $mail->Password = 'Goldeneagle16.'; //Modificar
		 
		 $mail->setFrom('ventas@jolcamotors.com','JOLCA MOTORS'); //Modificar

...
<!-- NAVBAR -->
<nav style="background-color:#0C2146;" class="navbar menu-principal navbar-expand-lg d-flex row">
    <a class="titulo navbar-brand m-3" href="index.php"><img src="img/logo1.png" width="90" height="55"></a>
    
    <!-- BUSCAR -->
    <?php if(isset($_POST['txtBuscarProducto']) == true){?>
    
            <form class="form-buscarProduc" action="index.php" method="post" style="padding:30px 0px!important;">
              <div class="input-group">
                <input id="inputBuscar" class="form-control" type="search" maxlength="70" name="txtBuscarProducto" placeholder="Producto a buscar" size="30" 
                        value="<?php echo trim($_POST['txtBuscarProducto']); ?>" required>
                <div class="input-group-append">
                  <button id="botonBuscar" class="btn bg-warning text-white botonBuscar" type="submit"><i class="fa fa-search mr-1" aria-hidden="true"></i></button>
                </div>
              </div>
            </form>
        
    <?php }else if(isset($_POST['txtBuscarProducto']) == false){?>
